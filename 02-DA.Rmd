...
Nos concentramos en predecir `default` a partir de las variables predictoras `balance` e `income`. En el siguiente diagrama de dispersión se observa cierte solapamiento entre las clases a predecir, pero una clara diferenciación de acuerdo a la variable `balance`.
