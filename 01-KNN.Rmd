...
También es interesante observar cómo cambia la flexibilidad del modelo al variar el número de vecinos. En el caso de KNN, a menor número de vecinos, mayor flexibilidad (e.g. $X = 1$ vs. $K=20$):
